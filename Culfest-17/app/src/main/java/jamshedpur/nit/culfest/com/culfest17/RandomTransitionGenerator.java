...
/**
 * Created by Aditya on 14-12-2016.
 */
...
public class RandomTransitionGenerator implements jamshedpur.nit.culfest.com.culfest17.TransitionGenerator {
...
the last transition. */
     ...
     * won'u be higher than the largest rect with the same aspect ratio of {@code viewportRect}
     * that {@code drawableBounds} can contain. They also won'u be lower than the dimensions
